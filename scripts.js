const textBlockData = {
  ...
  "rs485-ttl": {
    ...
    ua: {
      title: "RS485-TTL",
      description:
        "Перехідна плата зі стандарту RS485 на TTL (транзисторно-транзисторна логіка). Використовується як з Arduino, так і в інших проектах."
    }
  },
  raspberry: {
    en: {
  ...
  "rs485-usb": {
    en: {
      title: "RS485-USB",
      description:
        "This is a module that allows the USB interface of the microcontroller to be transferred to the RS485 module. It is generally used for industrial automation."
    },
    ua: {
      title: "RS485-USB",
      description:
        "Перехідна плата зі стандарту RS485 на USB (транзисторно-транзисторна логіка). Використовується як з Arduino, так і в інших проектах."
    }
  },
  wifi: {
    en: {
      title: "Wi-Fi module",
      description:
        "WiFi Module is a self contained SOC with integrated TCP/IP protocol stack that can give any microcontroller access to your WiFi network."
    },
    ua: {
      title: "Модуль wi-fi",
      description:
        "Модуль WiFi є автономним SOC з інтегрованим стеком протоколів TCP / IP, який може надати будь-якому доступу мікроконтролера до вашої мережі WiFi."
    }
  },
  ds18b20: {
    en: {
    ...
    ua: {
      title: "DS18B20",
      description:
        "DS18B20 це цифровий вимірювач температури, з дозволом перетворення 9 - 12 розрядів і функцією тривожного сигналу контролю за температурою. Параметри контролю можуть бути задані користувачем і збережені в енергонезалежній пам'яті датчика."
    }
  },
  "solar-panel": {
    en: {
      title: "Solar panel",
      description:
        "Solar panel - a type of panel panels for the absorption of energy from sunlight and its transformation into electric or thermal."
    },
    ua: {
  ...
  peltye: {
    en: {
      ...
      description:
        "The Peltier element is a thermoelectric converter, whose principle of action is based on the Peltier effect - the occurrence of temperature differences in the flow of electric current. In English literature, the elements of the Peltier are denoted by the TEC (from the English Thermoelectric Cooler - thermoelectric cooler)."
    },
    ua: {
  ...
  "light-sensor": {
    en: {
      title: "Light sensor",
      description:
        "The light sensor measures its level and sends the result to the main server."
    },
    ua: {
      title: "Датчик освітленості",
      description:
        "Датчик освітленості, вимірює її рівень та надсилає результат до основного серверу."
    }
  },
  "solar-panel-voltage": {
    en: {
    ...
    ua: {
      title: "Mодуль вимірювання напруги",
  ...
  "solar-panel-amperage": {
    en: {
      ...
      description:
        "Measure the power of the current amperage on the solar panel."
    },
    ua: {
...
function generate_field_texts(state) {
  ...
  Object.keys(textBlockData).map(ob => {
    ...
    if ($.inArray(ob, ["en-lang", "ua-lang"]) == -1) {
      $("." + ob).click(function(e) {
        $("#modalWindow #modalWindowTitle").html(
          textBlockData[ob][lang]["title"]
        );
        $("#modalWindow #text-description").html(
          textBlockData[ob][lang]["description"]
        );

        let type = ".jpg";
        const png_images = ["solar-panel", "ds18b20", "pir", "flower"];
